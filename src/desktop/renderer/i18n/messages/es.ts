...
export const es: Messages = {
  ...
  "onboarding.localBody": "Ejecuta modelos en este Mac o en tu red de IA local. Privado y sin conexión.",
  ...
  "onboarding.server": "Ollama / oMLX o LM Studio",
  "onboarding.serverBody": "Conecta directamente o mediante NVIDIA PAIR.",
  ...
  "onboarding.connectServerHint":
    "Conecta directamente con Ollama / oMLX o LM Studio, o mediante NVIDIA PAIR; las direcciones locales predeterminadas ya están rellenadas.",
  ...
  "onboarding.noLocalFit": "Ningún modelo local cabe en este Mac; vuelve y elige uno en la nube.",
  "onboarding.bestModel": "Mejor modelo para tu Mac",
  ...
  "settings.localServersNote":
    "Conecta directamente con Ollama / oMLX o LM Studio. Si usas NVIDIA PAIR, introduce las direcciones de bucle local mostradas en PAIR → Endpoints. Solo se necesita un punto de conexión operativo.",
