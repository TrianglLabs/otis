...
export const es: Messages = {
  ...
  "canvas.empty": "Abre un bloque Mermaid para usar el Lienzo.",
  "canvas.diagram": "Diagrama del Lienzo",
  ...
  "composer.unsupportedImage": "{{name}} no es una imagen compatible. Usa PNG, JPEG, GIF, BMP, TIFF o PPM.",
  "composer.thatFile": "Ese archivo",
  "composer.imageEmpty": "{{name}} está vacío.",
  ...
  "composer.imageReadFailed": "No se pudo leer la imagen.",
  ...
  "composer.addImages": "Añadir imágenes",
