...
export const es: Messages = {
  ...
  "canvas.tabs": "Documentos abiertos",
  "canvas.closeTab": "Cerrar {{title}}",
  ...
  "permission.waiting": "+{{count}} en espera",
  "session.working": "Trabajando",
  "session.finished": "Terminada",
  "session.open": "Abierta",
  "session.new": "Nueva sesión",
  "pane.close": "Cerrar panel",
  "pane.solo": "Mostrar solo esta sesión",
  ...
  "settings.skillsAll": "Todos los skills",
  "settings.skillsLoading": "Leyendo skills…",
  "settings.noSkills": "No hay skills cargados.",
  "settings.skillsNote":
    "Los skills personales están en ~/.agents/skills y los del proyecto en .agents/skills de la carpeta de trabajo. Abrir esta página los vuelve a leer.",
  ...
  "settings.noSkillsInstalled": "Aún no hay nada instalado.",
  "settings.skillCollectionSkills": { one: "{{count}} skill", other: "{{count}} skills" },
  "settings.skillUrl": "URL de Git",
  "settings.skillInstall": "Instalar",
  "settings.skillUpdate": "Actualizar",
  "settings.skillRemove": "Quitar",
  "settings.skillsShown": "{{shown}} de {{total}} skills",
  "settings.skillsMore": "Mostrar más",
  "settings.skillsWorking": "Trabajando con Git…",
