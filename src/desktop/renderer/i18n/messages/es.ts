...
export const es: Messages = {
  ...
  "onboarding.server": "Ollama o LM Studio",
  ...
  "onboarding.connectServerHint":
    "Conecta directamente con Ollama o LM Studio, o mediante NVIDIA PAIR; las direcciones locales predeterminadas ya están rellenadas.",
  ...
  "settings.localServersNote":
    "Conecta directamente con Ollama o LM Studio. Si usas NVIDIA PAIR, introduce las direcciones de bucle local mostradas en PAIR → Endpoints. Solo se necesita un punto de conexión operativo.",
