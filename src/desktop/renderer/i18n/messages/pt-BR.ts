...
export const ptBR: Messages = {
  ...
  "onboarding.localBody": "Execute modelos neste Mac ou na sua rede local de IA. Privado e funciona offline.",
  ...
  "onboarding.serverBody": "Conecte diretamente ou pelo NVIDIA PAIR.",
  ...
  "onboarding.connectServerHint":
    "Conecte diretamente ao Ollama / oMLX ou LM Studio, ou pelo NVIDIA PAIR; os endereços locais padrão já estão preenchidos.",
  ...
  "onboarding.noLocalFit": "Nenhum modelo local cabe neste Mac — volte e escolha Hospedado.",
  "onboarding.bestModel": "Melhor modelo para o seu Mac",
  ...
  "settings.localServersNote":
    "Conecte diretamente ao Ollama / oMLX ou LM Studio. Se usar o NVIDIA PAIR, informe os endereços de loopback mostrados em PAIR → Endpoints. Basta um endpoint funcionar.",
