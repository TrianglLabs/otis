...
export const ptBR: Messages = {
  ...
  "onboarding.connectServerHint":
    "Conecte diretamente ao Ollama ou LM Studio, ou pelo NVIDIA PAIR; os endereços locais padrão já estão preenchidos.",
  ...
  "settings.localServersNote":
    "Conecte diretamente ao Ollama ou LM Studio. Se usar o NVIDIA PAIR, informe os endereços de loopback mostrados em PAIR → Endpoints. Basta um endpoint funcionar.",
