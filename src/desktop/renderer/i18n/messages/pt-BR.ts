...
export const ptBR: Messages = {
  ...
  "canvas.tabs": "Documentos abertos",
  "canvas.closeTab": "Fechar {{title}}",
  ...
  "permission.waiting": "+{{count}} aguardando",
  "session.working": "Trabalhando",
  "session.finished": "Concluída",
  "session.open": "Aberta",
  "session.new": "Nova sessão",
  "pane.close": "Fechar painel",
  "pane.solo": "Mostrar só esta sessão",
  ...
  "settings.skillsAll": "Todos os skills",
  "settings.skillsLoading": "Lendo skills…",
  "settings.noSkills": "Nenhum skill carregado.",
  "settings.skillsNote":
    "Skills pessoais ficam em ~/.agents/skills e os do projeto em .agents/skills da pasta de trabalho. Abrir esta página os relê.",
  "settings.skillBundled": "Incluído",
  "settings.skillPersonal": "Pessoal",
  "settings.skillProject": "Projeto",
  "settings.skillsInstalled": "Skills instalados",
  "settings.noSkillsInstalled": "Nada instalado ainda.",
  "settings.skillCollectionSkills": { one: "{{count}} skill", other: "{{count}} skills" },
  "settings.skillUrl": "URL do Git",
  "settings.skillInstall": "Instalar",
  "settings.skillUpdate": "Atualizar",
  "settings.skillRemove": "Remover",
  "settings.skillsShown": "{{shown}} de {{total}} skills",
  "settings.skillsMore": "Mostrar mais",
  "settings.skillsWorking": "Trabalhando com o Git…",
