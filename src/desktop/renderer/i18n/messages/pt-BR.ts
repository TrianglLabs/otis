...
export const ptBR: Messages = {
  ...
  "canvas.empty": "Abra um bloco Mermaid para usar a Tela.",
  "canvas.diagram": "Diagrama da Tela",
  ...
  "composer.dropImages": "Solte as imagens aqui",
  "composer.attachedImages": "Imagens anexadas",
  "composer.removeImage": "Remover {{name}}",
  ...
  "composer.unsupportedImage": "{{name}} não é uma imagem compatível. Use PNG, JPEG, GIF, BMP, TIFF ou PPM.",
  "composer.thatFile": "Esse arquivo",
  "composer.imageEmpty": "{{name}} está vazio.",
  ...
  "composer.imageReadFailed": "Não foi possível ler a imagem.",
  ...
  "composer.addImages": "Adicionar imagens",
