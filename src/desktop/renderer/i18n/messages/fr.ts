...
export const fr: Messages = {
  ...
  "canvas.empty": "Ouvrez un bloc Mermaid pour utiliser le Canevas.",
  "canvas.diagram": "Diagramme du Canevas",
  ...
  "composer.dropImages": "Déposez les images ici",
  "composer.attachedImages": "Images jointes",
  "composer.removeImage": "Retirer {{name}}",
  ...
  "composer.unsupportedImage":
    "{{name}} n’est pas une image prise en charge. Utilisez PNG, JPEG, GIF, BMP, TIFF ou PPM.",
  "composer.thatFile": "Ce fichier",
  "composer.imageEmpty": "{{name}} est vide.",
  ...
  "composer.imageReadFailed": "Impossible de lire l’image.",
  ...
  "composer.addImages": "Ajouter des images",
