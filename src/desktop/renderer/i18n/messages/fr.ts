...
export const fr: Messages = {
  ...
  "canvas.tabs": "Documents ouverts",
  "canvas.closeTab": "Fermer {{title}}",
  ...
  "permission.waiting": "+{{count}} en attente",
  "session.working": "En cours",
  "session.finished": "Terminée",
  "session.open": "Ouverte",
  "session.new": "Nouvelle session",
  "pane.close": "Fermer le volet",
  "pane.solo": "Afficher seulement cette session",
  ...
  "settings.skillsAll": "Tous les skills",
  "settings.skillsLoading": "Lecture des skills…",
  "settings.noSkills": "Aucun skill chargé.",
  "settings.skillsNote":
    "Les skills personnels sont dans ~/.agents/skills, ceux du projet dans .agents/skills du dossier de travail. Ouvrir cette page les relit.",
  "settings.skillBundled": "Intégré",
  "settings.skillPersonal": "Personnel",
  "settings.skillProject": "Projet",
  "settings.skillsInstalled": "Skills installés",
  "settings.noSkillsInstalled": "Rien d'installé pour l'instant.",
  "settings.skillCollectionSkills": { one: "{{count}} skill", other: "{{count}} skills" },
  "settings.skillUrl": "URL Git",
  "settings.skillInstall": "Installer",
  "settings.skillUpdate": "Mettre à jour",
  "settings.skillRemove": "Retirer",
  "settings.skillsShown": "{{shown}} skills sur {{total}}",
  "settings.skillsMore": "Afficher plus",
  "settings.skillsWorking": "Git travaille…",
