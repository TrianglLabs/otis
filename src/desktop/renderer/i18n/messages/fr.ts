...
export const fr: Messages = {
  ...
  "onboarding.server": "Ollama ou LM Studio",
  ...
  "onboarding.connectServerHint":
    "Connectez-vous directement à Ollama ou LM Studio, ou via NVIDIA PAIR ; les adresses locales par défaut sont préremplies.",
  ...
  "settings.localServersNote":
    "Connectez-vous directement à Ollama ou LM Studio. Avec NVIDIA PAIR, saisissez les adresses de bouclage indiquées dans PAIR → Endpoints. Un seul point de terminaison fonctionnel suffit.",
