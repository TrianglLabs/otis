...
export const fr: Messages = {
  ...
  "onboarding.localBody": "Exécutez les modèles sur ce Mac ou votre réseau d’IA local. Privé et hors ligne.",
  ...
  "onboarding.server": "Ollama / oMLX ou LM Studio",
  "onboarding.serverBody": "Connexion directe ou via NVIDIA PAIR.",
  ...
  "onboarding.connectServerHint":
    "Connectez-vous directement à Ollama / oMLX ou LM Studio, ou via NVIDIA PAIR ; les adresses locales par défaut sont préremplies.",
  ...
  "onboarding.noLocalFit": "Aucun modèle local ne convient à ce Mac — revenez en arrière et choisissez Hébergé.",
  "onboarding.bestModel": "Meilleur modèle pour votre Mac",
  ...
  "settings.localServersNote":
    "Connectez-vous directement à Ollama / oMLX ou LM Studio. Avec NVIDIA PAIR, saisissez les adresses de bouclage indiquées dans PAIR → Endpoints. Un seul point de terminaison fonctionnel suffit.",
