...
const themes: Record<ThemeName, ThemeColors> = {
  ...
  pearl: {
    ...
    border: "#D0D2D8",
    diffAddedBg: "#E5F1E8",
    diffRemovedBg: "#FBE8E7",
    diffContextBg: "#F5F5F7",
    diffAddedContentBg: "#D1E7D8",
    diffRemovedContentBg: "#F6D4D4",
    diffContextContentBg: "#F5F5F7",
    diffLineNumberFg: "#707077",
  },
  sage: {
    background: "#F3F5F1",
    surface: "#FDFEFC",
    ...
    border: "#CAD2C8",
    diffAddedBg: "#DFECDC",
    diffRemovedBg: "#F4E4E3",
    diffContextBg: "#F3F5F1",
    diffAddedContentBg: "#CDE2C8",
    diffRemovedContentBg: "#EBCDCC",
    diffContextContentBg: "#F3F5F1",
    diffLineNumberFg: "#667163",
  },
  titanium: {
    background: "#1C1D20",
    surface: "#282A2E",
    ...
    border: "#44474E",
    diffAddedBg: "#22392C",
    diffRemovedBg: "#40282C",
    diffContextBg: "#1C1D20",
    diffAddedContentBg: "#2A4836",
    diffRemovedContentBg: "#523139",
    diffContextContentBg: "#1C1D20",
    diffLineNumberFg: "#92969E",
  },
}
